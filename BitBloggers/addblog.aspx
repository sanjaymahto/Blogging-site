...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="btnPost" runat="server" OnClick="btnPost_Click" 
        Text="Post Blog" BackColor="Black" BorderStyle="Outset" Font-Bold="True" 
        Font-Names="Adobe Gothic Std B" Font-Size="Large" ForeColor="#11FF11" 
        Height="37px" Width="147px" /><br />
    <br />
